...
var _Root = _interopRequireDefault(__webpack_require__(25));
...
var _Controls = _interopRequireDefault(__webpack_require__(26));

var _List = _interopRequireDefault(__webpack_require__(27));
...
function (_Component) {
  function Root() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Root)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      tasks: {}
    }, _this.counterForState = null, _this.handleAddItem = function (value) {
      if (_this.counterForState === null) {
        //check counterForState if null, set number 0, else - use incremnt 
        _this.counterForState = 0;
      } else {
        _this.counterForState += 1;
      }

      if (value) {
        // check value, if empty - skip
        var newState = _objectSpread({}, _this.state.tasks); //temporary state for a copy state


        newState[_this.counterForState] = value;

        _this.setState({
          tasks: newState
        });
      }
    }, _this.removeItemFromState = function (keyId) {
      var newState = _objectSpread({}, _this.state.tasks); //temporary state for a copy state
      ...
      ;
    }, _this.editItemFromState = function (value, keyId) {
      var newState = _objectSpread({}, _this.state.tasks); //temporary state for a copy state 
  ...
  _createClass(Root, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(_Controls.default, {
...
/*#__PURE__*/
function (_Component) {
  function Controls(props, context, updater) {
    var _this;

    _classCallCheck(this, Controls);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Controls).call(this, props, context, updater));
    _this.state = {
      value: ''
    };
    _this.handleInput = _this.handleInput.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.handlePress = _this.handlePress.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Controls, [{
    ...
    value: function handleInput(event) {
      var _event$target$value = event.target.value,
          value = _event$target$value === void 0 ? '' : _event$target$value;
      this.setState({
        value: value
      });
    }
...
function (_Component) {
  ...
  _createClass(List, [{
    key: "getEditPrompt",
    value: function getEditPrompt(event) {
      var result = prompt("Сhange the task, please", event.target.parentElement.textContent);
    ...
    value: function render() {
      ...
      var Li = _react.default.createElement("div", null, function (tasks) {
        //bind context to this - arrow function
        var array = [];

        var _loop = function _loop(task) {
          //important use let, let copy variable each iteration
          array.push(_react.default.createElement("li", {
            key: task
          }, tasks[task], _react.default.createElement("i", {
            className: "far fa-edit edit",
            onClick: function onClick(event) {
              return _this.props.onEdit(_this.getEditPrompt(event), task);
            }
          }), _react.default.createElement("i", {
            className: "fas fa-times close",
            onClick: function onClick() {
              return _this.props.onRemove(task);
            }
          })));
        };
      ...
      return _react.default.createElement("ul", null, Li);
    }
  }]);
